...
function Project({ project }: { project: Project }){
    return (
        <Card className="group flex flex-col justify-center border-2 md:hover:border-emerald-300 md:dark:hover:border-emerald-600 transition duration-200">
            <img src={project.image} className="rounded-t-md group-hover:contrast-[1.1] transition duration-200"/>
                    ...
                    <Tooltip>
                        <TooltipTrigger className="cursor-default h-[40px] w-[40px]">
                            <Button size="icon" className="h-[40px] w-[40px]">
                                <Link to={project.gitUrl} target="_blank" rel="noopener noreferrer">
                                    <img src="./github-mark.svg" className="p-1 invert dark:invert-0" />
                                </Link>
                            </Button>
                        </TooltipTrigger>
                        <TooltipContent>
